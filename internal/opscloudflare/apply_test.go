...
func deployConfirmedPlan(payloadDigest string) opscloudflare.CloudflareDeployPlan {
	return opscloudflare.CloudflareDeployPlan{Service: "example-relay", Environment: "production", RequestedVersion: "2026.09.14-1", Worker: "example-worker", AccountID: "0123456789abcdef0123456789abcdef", WranglerConfig: "wrangler.jsonc", WranglerConfigSHA256: strings.Repeat("1", 64), WranglerVersion: "4.107.0", BaseCommit: strings.Repeat("2", 40), ScopeState: "clean", ScopeContentSHA256: strings.Repeat("3", 64), DeploymentInputSHA256: payloadDigest, CurrentDeploymentID: "11111111-1111-4111-8111-111111111111", CurrentVersionIDs: []string{"aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa"}, DryRunVerified: true, SourcePath: "/tmp/example-relay", Timeout: 5 * time.Second}
}
